...
export const categoryOptions = [
  ...
  { label: "Rental Income", catClass: "bg-success-container text-on-success-container" },
  { label: "Utilities", catClass: "bg-primary-fixed text-primary" },
  { label: "Office Supplies", catClass: "bg-blue-50 text-blue-600" },
  { label: "Contractor", catClass: "bg-primary-fixed text-primary" },
...
export const allTransactions: Transaction[] = [
  ...
  },
  {
    ...
    catClass: "bg-success-container text-on-success-container",
    amount: "+$3,200.00",
    amountClass: "text-success-dim",
    property: "Main St. Loft",
    highlight: false,
    bankAccount: "Chase Business Checking ····4521",
  },
  ...
  },
  {
    ...
    category: "Utilities",
    catClass: "bg-primary-fixed text-primary",
    amount: "-$118.40",
    amountClass: "text-on-surface",
    property: "Downtown Plaza",
    highlight: false,
